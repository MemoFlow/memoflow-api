 ...
 * `planning_jobs` id — the (later) worker loads everything else it needs
 * straight from Mongo, so the queue message stays minimal and the port
 * doesn't leak the entity shape.
 */
